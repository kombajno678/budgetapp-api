"""added column last_generated_operations_at

Revision ID: 687b10756a75
Revises: 2210fa06895a
Create Date: 2020-11-30 19:39:21.901007
...
revision = '687b10756a75'
down_revision = '2210fa06895a'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('scheduled_operation_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('when', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['scheduled_operation_id'], ['scheduled_operation.id'], name='operation_scheduled_operation_id_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='operation_user_id_fkey'),
    ...
    sa.Column('auth_id', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    ...
    sa.Column('timestamp', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('when', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('exact_value', postgresql.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='fixed_point_user_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['schedule_id'], ['schedule.id'], name='scheduled_operation_schedule_id_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='scheduled_operation_user_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='scheduled_operation_pkey')
    )
    # ### end Alembic commands ###
